...
- ls -la logs
  stdout:
  total 12
  drwxrwxr-x 2 ilya ilya 4096 Jan 29 08:14 .
  drwxrwxr-x 8 ilya ilya 4096 Jan 29 08:14 ..
  -rw-rw-r-- 1 ilya ilya 1234 Jan 29 08:20 events.jsonl
  -rw-rw-r-- 1 ilya ilya    0 Jan 28 17:51 .gitkeep
  stderr:
  (empty)
- read logs/events.jsonl (first ~5 lines)
  stdout:
  1| {"ts": "2026-01-29T05:14:25.191376+00:00", "level": "INFO", "event": "decision", "message": "SOL Liquidity Navigator starting", "python_version": "3.10.12", "instrument": "SOL/USDT-PERP", "timeframes_entry": ["M1", "M5"], "timeframe_context": "H1", "log_dir": "/home/ilya/club/logs"}
  2| {"ts": "2026-01-29T05:14:25.191814+00:00", "level": "INFO", "event": "decision", "message": "Stage1 wiring only: no strategy evaluation", "risk_off_threshold": -0.01, "risk_off_window_min": 60, "weekend_stop_start_weekday": 4, "weekend_stop_start_minute_utc": 1260, "weekend_stop_end_weekday": 0, "weekend_stop_end_minute_utc": 360}
  3| {"ts": "2026-01-29T05:20:40.079893+00:00", "level": "INFO", "event": "decision", "message": "SOL Liquidity Navigator starting", "python_version": "3.10.12", "instrument": "SOL/USDT-PERP", "timeframes_entry": ["M1", "M5"], "timeframe_context": "H1", "log_dir": "/home/ilya/club/logs"}
  4| {"ts": "2026-01-29T05:20:40.080140+00:00", "level": "INFO", "event": "decision", "message": "Stage1 wiring only: no strategy evaluation", "risk_off_threshold": -0.01, "risk_off_window_min": 60, "weekend_stop_start_weekday": 4, "weekend_stop_start_minute_utc": 1260, "weekend_stop_end_weekday": 0, "weekend_stop_end_minute_utc": 360}
  stderr:
  (empty)
- ls -la .opencode/workflow
  stdout:
  total 584
  drwxrwxr-x 2 ilya ilya   4096 Jan 29 08:19 .
  drwxrwxr-x 6 ilya ilya   4096 Jan 29 08:19 ..
  -rw-rw-r-- 1 ilya ilya  11592 Jan 29 08:11 00_PM_REQUEST.md
  -rw-rw-r-- 1 ilya ilya   6219 Jan 29 08:19 01_ARCH_TASKS.md
  -rw-rw-r-- 1 ilya ilya  17308 Jan 29 08:12 02_EXECUTOR_REPORT.md
  -rw-rw-r-- 1 ilya ilya   3178 Jan 29 08:14 03_CRITIC_REPORT.md
  -rw-rw-r-- 1 ilya ilya   3010 Jan 29 08:17 04_AUDITOR_REPORT.md
  -rw-rw-r-- 1 ilya ilya   1814 Jan 28 20:38 ACCEPTANCE.md
  -rwxrwxr-x 1 ilya ilya    901 Jan 28 13:41 daemon_ctl.sh
  -rw-rw-r-- 1 ilya ilya 391381 Jan 29 08:19 daemon.log
  -rw-rw-r-- 1 ilya ilya      6 Jan 29 08:11 daemon.pid
  -rwxrwxr-x 1 ilya ilya   1018 Jan 28 16:12 daemon.sh
  -rw-rw-r-- 1 ilya ilya   1783 Jan 29 08:17 DIALOGUE.md
  -rw-rw-r-- 1 ilya ilya  38487 Jan 29 08:20 ISSUES.md
  -rw-rw-r-- 1 ilya ilya      0 Jan 29 08:11 .lock
  -rwxrwxr-x 1 ilya ilya   4190 Jan 28 16:58 pipeline.sh
  -rw-rw-r-- 1 ilya ilya     65 Jan 29 08:11 .pm_request_hash
  -rw-rw-r-- 1 ilya ilya    121 Jan 28 14:33 .prompt_auditor_smoke.txt
  -rw-rw-r-- 1 ilya ilya    378 Jan 29 08:17 .prompt_auditor.txt
  -rw-rw-r-- 1 ilya ilya    139 Jan 28 14:27 .prompt_critic_smoke.txt
  -rw-rw-r-- 1 ilya ilya    410 Jan 29 08:17 .prompt_critic.txt
  -rw-rw-r-- 1 ilya ilya    152 Jan 28 14:27 .prompt_exec_smoke.txt
  -rw-rw-r-- 1 ilya ilya    298 Jan 29 08:17 .prompt_exec.txt
  -rw-rw-r-- 1 ilya ilya    351 Jan 29 08:17 .prompt_orch_a.txt
  -rw-rw-r-- 1 ilya ilya    222 Jan 29 08:17 .prompt_orch_b.txt
  ...
  -rw-rw-r-- 1 ilya ilya   5296 Jan 29 06:58 selftest.sh
  -rw-rw-r-- 1 ilya ilya   5710 Jan 29 08:21 .step_executor.log
  stderr:
  (empty)
NOTES/RISKS:
- Gate 1 comparator ambiguity handled per 01_ARCH_TASKS option: BTC_RISK_OFF_COMPARATOR is None with both comparator candidates documented. Snippet (config.py lines 87-92): BTC_RISK_OFF_RETURN_60M = -0.010; BTC_RISK_OFF_COMPARATOR = None; BTC_RISK_OFF_COMPARATOR_PSEUDOCODE = "<="; BTC_RISK_OFF_COMPARATOR_PROSE = "<"; BTC_RISK_OFF_WINDOW_MINUTES = 60; BTC_RISK_OFF_EDGE_CASE_AT_THRESHOLD = "btc_return_60m == -0.010". Cross-reference: ISSUES.md entries for Gate 1 comparator ambiguity.
- Runtime artifacts policy remains pending for repo-root `_selftest_backup/` and `__pycache__/`/`*.pyc` (allow+ignore vs mandatory cleanup). Evidence commands created/updated `__pycache__/` and `logs/events.jsonl`.
- Required workflow artifacts present and non-empty at canonical paths per `ls -la .opencode/workflow` output above.
- Default logging is durable (LOG_OUTPUT_TARGET="file") and `logs/events.jsonl` contains decision entries; Stage1 main logs only wiring decisions.
- No changes made to STRATEGY_KNOWLEDGE_BASE.md.
