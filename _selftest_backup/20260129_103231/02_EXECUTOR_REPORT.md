STATUS: FAIL
FILES: created/changed: .opencode/workflow/02_EXECUTOR_REPORT.md
TREE:
.
├── config.py
├── core
...
OUTPUT:
workflow before selftest:
$ ls -la .opencode/workflow
(total 756)
drwxrwxr-x 2 ilya ilya   4096 Jan 29 10:11 .
drwxrwxr-x 6 ilya ilya   4096 Jan 29 10:12 ..
-rw-rw-r-- 1 ilya ilya  16462 Jan 29 09:56 00_PM_REQUEST.md
-rw-rw-r-- 1 ilya ilya   6194 Jan 29 10:11 01_ARCH_TASKS.md
-rw-rw-r-- 1 ilya ilya  19118 Jan 29 10:03 02_EXECUTOR_REPORT.md
-rw-rw-r-- 1 ilya ilya   3619 Jan 29 10:08 03_CRITIC_REPORT.md
-rw-rw-r-- 1 ilya ilya   3270 Jan 29 10:09 04_AUDITOR_REPORT.md
-rw-rw-r-- 1 ilya ilya   1814 Jan 28 20:38 ACCEPTANCE.md
-rwxrwxr-x 1 ilya ilya    901 Jan 28 13:41 daemon_ctl.sh
-rw-rw-r-- 1 ilya ilya 531939 Jan 29 10:11 daemon.log
-rw-rw-r-- 1 ilya ilya      6 Jan 29 09:56 daemon.pid
-rwxrwxr-x 1 ilya ilya   1018 Jan 28 16:12 daemon.sh
-rw-rw-r-- 1 ilya ilya   9473 Jan 29 10:09 DIALOGUE.md
-rw-rw-r-- 1 ilya ilya  53407 Jan 29 10:08 ISSUES.md
-rw-rw-r-- 1 ilya ilya      0 Jan 29 09:56 .lock
-rwxrwxr-x 1 ilya ilya   4190 Jan 28 16:58 pipeline.sh
-rw-rw-r-- 1 ilya ilya     65 Jan 29 09:56 .pm_request_hash
-rw-rw-r-- 1 ilya ilya    121 Jan 28 14:33 .prompt_auditor_smoke.txt
-rw-rw-r-- 1 ilya ilya    378 Jan 29 10:10 .prompt_auditor.txt
-rw-rw-r-- 1 ilya ilya    139 Jan 28 14:27 .prompt_critic_smoke.txt
-rw-rw-r-- 1 ilya ilya    410 Jan 29 10:10 .prompt_critic.txt
-rw-rw-r-- 1 ilya ilya    152 Jan 28 14:27 .prompt_exec_smoke.txt
-rw-rw-r-- 1 ilya ilya    298 Jan 29 10:10 .prompt_exec.txt
-rw-rw-r-- 1 ilya ilya    351 Jan 29 10:10 .prompt_orch_a.txt
-rw-rw-r-- 1 ilya ilya    222 Jan 29 10:10 .prompt_orch_b.txt
-rw-rw-r-- 1 ilya ilya     36 Jan 28 16:24 .prompt__runner_selftest.txt
-rw-rw-r-- 1 ilya ilya    179 Jan 28 15:22 .prompt_test_dialogue_by_exec.txt
-rw-rw-r-- 1 ilya ilya    134 Jan 28 15:00 .prompt_test_runner_exec.txt
-rw-rw-r-- 1 ilya ilya    185 Jan 28 15:00 .prompt_test_runner_orch.txt
-rw-rw-r-- 1 ilya ilya    165 Jan 28 11:58 .prompt_test.txt
-rwxrwxr-x 1 ilya ilya    416 Jan 28 16:07 runner.sh
-rw-rw-r-- 1 ilya ilya   6548 Jan 29 09:56 selftest.sh
-rw-rw-r-- 1 ilya ilya    243 Jan 29 10:12 .step_executor.log

selftest output:
$ bash .opencode/workflow/selftest.sh --mode infra --wait 120
=== SELFTEST v2.1 START: 2026-01-29T10:13:30+03:00 ===
ROOT=/home/ilya/club
MODE=infra
DESTRUCTIVE=0
WAIT=120
[TEST] Triggering flood (10x)...
[TEST] Single-flight deterministic lock check...
PASS: Single-flight contention detected in log.
[TEST] Waiting for pipeline cycle (max 120 s)...
Wait 0s... Found: [pipeline] another run is active, exiting 2026-01-29T10:13:41+03:00
Wait 30s... Found: [pipeline] another run is active, exiting 2026-01-29T10:13:41+03:00
Wait 60s... Found: [pipeline] another run is active, exiting 2026-01-29T10:13:41+03:00
Wait 90s... Found: [pipeline] another run is active, exiting 2026-01-29T10:13:41+03:00
(timeout 120s; no completion)

workflow after selftest:
$ ls -la .opencode/workflow
(total 756)
drwxrwxr-x 2 ilya ilya   4096 Jan 29 10:11 .
drwxrwxr-x 6 ilya ilya   4096 Jan 29 10:12 ..
-rw-rw-r-- 1 ilya ilya  16913 Jan 29 10:13 00_PM_REQUEST.md
-rw-rw-r-- 1 ilya ilya   6194 Jan 29 10:11 01_ARCH_TASKS.md
-rw-rw-r-- 1 ilya ilya  19118 Jan 29 10:03 02_EXECUTOR_REPORT.md
-rw-rw-r-- 1 ilya ilya   3619 Jan 29 10:08 03_CRITIC_REPORT.md
-rw-rw-r-- 1 ilya ilya   3270 Jan 29 10:09 04_AUDITOR_REPORT.md
-rw-rw-r-- 1 ilya ilya   1814 Jan 28 20:38 ACCEPTANCE.md
-rwxrwxr-x 1 ilya ilya    901 Jan 28 13:41 daemon_ctl.sh
-rw-rw-r-- 1 ilya ilya 532096 Jan 29 10:13 daemon.log
-rw-rw-r-- 1 ilya ilya      6 Jan 29 09:56 daemon.pid
-rwxrwxr-x 1 ilya ilya   1018 Jan 28 16:12 daemon.sh
-rw-rw-r-- 1 ilya ilya   9473 Jan 29 10:09 DIALOGUE.md
-rw-rw-r-- 1 ilya ilya  53407 Jan 29 10:08 ISSUES.md
-rw-rw-r-- 1 ilya ilya      0 Jan 29 10:13 .lock
-rwxrwxr-x 1 ilya ilya   4190 Jan 28 16:58 pipeline.sh
-rw-rw-r-- 1 ilya ilya     65 Jan 29 09:56 .pm_request_hash
-rw-rw-r-- 1 ilya ilya    121 Jan 28 14:33 .prompt_auditor_smoke.txt
-rw-rw-r-- 1 ilya ilya    378 Jan 29 10:10 .prompt_auditor.txt
...
-rwxrwxr-x 1 ilya ilya    416 Jan 28 16:07 runner.sh
-rw-rw-r-- 1 ilya ilya   6548 Jan 29 09:56 selftest.sh
-rw-rw-r-- 1 ilya ilya  12288 Jan 29 10:15 .step_executor.log

logs directory listing:
$ ls -la logs
(total 12)
drwxrwxr-x 2 ilya ilya 4096 Jan 29 09:59 .
drwxrwxr-x 8 ilya ilya 4096 Jan 29 09:59 ..
-rw-rw-r-- 1 ilya ilya 2468 Jan 29 10:13 events.jsonl
-rw-rw-r-- 1 ilya ilya    0 Jan 28 17:51 .gitkeep

logs/events.jsonl excerpt:
{"ts": "2026-01-29T07:13:09.648144+00:00", "level": "INFO", "event": "decision", "message": "SOL Liquidity Navigator starting", "python_version": "3.10.12", "instrument": "SOL/USDT-PERP", "timeframes_entry": ["M1", "M5"], "timeframe_context": "H1", "log_dir": "/home/ilya/club/logs"}
{"ts": "2026-01-29T07:13:09.648432+00:00", "level": "INFO", "event": "decision", "message": "Stage1 wiring only: no strategy evaluation", "risk_off_threshold": -0.01, "risk_off_window_min": 60, "weekend_stop_start_weekday": 4, "weekend_stop_start_minute_utc": 1260, "weekend_stop_end_weekday": 0, "weekend_stop_end_minute_utc": 360}

COMMANDS:
1) ls -la .opencode/workflow
2) tree -a -L 4
3) ls -la logs
4) python3 -m py_compile config.py main.py core/*.py infrastructure/*.py
   stdout: (empty)
   stderr: (empty)
   exit: 0
5) python3 main.py
...
if path.exists():
    ...
    for line in lines[-2:]:
        print(line)
PY
7) bash .opencode/workflow/selftest.sh --mode infra --wait 120
8) ls -la .opencode/workflow (post-selftest)
9) ls -la _selftest_backup

NOTES/RISKS:
- Selftest infra run timed out at 120s with "another run is active" messages; workflow artifacts remained present, but pipeline completion was not observed.
- Gate 1 BTC Risk-Off comparator decision pending (strict "< -0.010" vs non-strict "<= -0.010"); config.py documents both and leaves BTC_RISK_OFF_COMPARATOR unset.
- Stage1 runtime-artifacts policy still needed for logs/events.jsonl, repo-root _selftest_backup/, and __pycache__/ *.pyc artifacts.

OUTPUT (config.py full text):
"""
