...
- ls
- ls ".opencode"
- ls ".opencode/workflow"
- python3 main.py
- ls "logs"
- tree -a -L 3
- tree -a -L 4 .opencode
NOTES/RISKS:
- Blocking clarification needed: BTC Risk-Off comparator at exactly -1.0% (WP §4.1 prose vs §4.4 pseudocode). Awaiting PM/orchestrator decision; logged in DIALOGUE.md and ISSUES.md.
- __pycache__/ and *.pyc artifacts present after running python3; cleanup handled in selftest.sh destructive mode but may persist after manual runs.
- jsonl persistence verified: logs/events.jsonl contains decision records written by logger when running main.py.
