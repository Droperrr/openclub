...
- .opencode/workflow/02_EXECUTOR_REPORT.md (created)
- logs/events.jsonl (updated by python3 main.py)
- __pycache__/ (generated by py_compile run)
TREE:
.
├── config.py
├── core
...
- ls -la logs
  stdout:
  total 12
  drwxrwxr-x 2 ilya ilya 4096 Jan 29 09:45 .
  drwxrwxr-x 8 ilya ilya 4096 Jan 29 09:45 ..
  -rw-rw-r-- 1 ilya ilya  617 Jan 29 09:45 events.jsonl
  -rw-rw-r-- 1 ilya ilya    0 Jan 28 17:51 .gitkeep
- logs/events.jsonl (excerpt)
  {"ts": "2026-01-29T06:45:24.021299+00:00", "level": "INFO", "event": "decision", "message": "SOL Liquidity Navigator starting", "python_version": "3.10.12", "instrument": "SOL/USDT-PERP", "timeframes_entry": ["M1", "M5"], "timeframe_context": "H1", "log_dir": "/home/ilya/club/logs"}
  {"ts": "2026-01-29T06:45:24.021559+00:00", "level": "INFO", "event": "decision", "message": "Stage1 wiring only: no strategy evaluation", "risk_off_threshold": -0.01, "risk_off_window_min": 60, "weekend_stop_start_weekday": 4, "weekend_stop_start_minute_utc": 1260, "weekend_stop_end_weekday": 0, "weekend_stop_end_minute_utc": 360}
NOTES/RISKS:
- Gate 1 BTC Risk-Off boundary comparator remains unresolved (WP §4.1 prose "more than 1.0%" vs §4.4 pseudocode <= -0.010). Config documents both with BTC_RISK_OFF_COMPARATOR=None; PM/orchestrator decision required.
- Runtime artifacts policy needed for logs/events.jsonl, repo-root _selftest_backup/, and __pycache__/pyc outputs. Current run created/updated logs/events.jsonl and __pycache__ via py_compile.
