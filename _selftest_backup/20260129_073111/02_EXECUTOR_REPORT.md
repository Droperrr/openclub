...
- infrastructure/__pycache__/*.pyc
TREE:
.
├── config.py
├── core
...
- Required structure present: STRATEGY_KNOWLEDGE_BASE.md, config.py, main.py, core/{__init__.py,engine.py,market_data.py,shadow_lab.py}, infrastructure/{__init__.py,logger.py,telegram_bot.py}, logs/.gitkeep (see TREE; tree -a shows dotfiles).
- main.py wiring-only: logger setup + startup logs only (main.py:16-35). No gate/signal branching.
...
- `python3 main.py`
  Output: (no stdout/stderr)
- logs/events.jsonl exists and contains records after main.py (see logs listing + excerpt below).

Logs evidence:
- `ls -la logs`:
  total 12
  drwxrwxr-x 2 ilya ilya 4096 Jan 29 07:18 .
  drwxrwxr-x 8 ilya ilya 4096 Jan 29 07:18 ..
  -rw-rw-r-- 1 ilya ilya 1851 Jan 29 07:22 events.jsonl
  -rw-rw-r-- 1 ilya ilya    0 Jan 28 17:51 .gitkeep
- logs/events.jsonl (first 5 lines):
  {"ts": "2026-01-29T04:18:31.768663+00:00", "level": "INFO", "event": "decision", "message": "SOL Liquidity Navigator starting", "python_version": "3.10.12", "instrument": "SOL/USDT-PERP", "timeframes_entry": ["M1", "M5"], "timeframe_context": "H1", "log_dir": "/home/ilya/club/logs"}
  {"ts": "2026-01-29T04:18:31.769050+00:00", "level": "INFO", "event": "decision", "message": "Stage1 wiring only: no strategy evaluation", "risk_off_threshold": -0.01, "risk_off_window_min": 60, "weekend_stop_start_weekday": 4, "weekend_stop_start_minute_utc": 1260, "weekend_stop_end_weekday": 0, "weekend_stop_end_minute_utc": 360}
  {"ts": "2026-01-29T04:18:33.545389+00:00", "level": "INFO", "event": "decision", "message": "SOL Liquidity Navigator starting", "python_version": "3.10.12", "instrument": "SOL/USDT-PERP", "timeframes_entry": ["M1", "M5"], "timeframe_context": "H1", "log_dir": "/home/ilya/club/logs"}
  {"ts": "2026-01-29T04:18:33.545535+00:00", "level": "INFO", "event": "decision", "message": "Stage1 wiring only: no strategy evaluation", "risk_off_threshold": -0.01, "risk_off_window_min": 60, "weekend_stop_start_weekday": 4, "weekend_stop_start_minute_utc": 1260, "weekend_stop_end_weekday": 0, "weekend_stop_end_minute_utc": 360}
  {"ts": "2026-01-29T04:22:03.057911+00:00", "level": "INFO", "event": "decision", "message": "SOL Liquidity Navigator starting", "python_version": "3.10.12", "instrument": "SOL/USDT-PERP", "timeframes_entry": ["M1", "M5"], "timeframe_context": "H1", "log_dir": "/home/ilya/club/logs"}

Workflow hygiene:
- `.opencode/_selftest_backup/**` is absent. Repo-root `_selftest_backup/` exists (legacy backups) — policy confirmation needed for acceptance cleanup/ignore.
- `__pycache__/` and `*.pyc` created by py_compile are present; policy needed for cleanup/ignore.
- Current session produced __pycache__ entries (see FILES list) after py_compile.
...
BTC_RISK_OFF_COMPARATOR = "<="  # why: Stage1 adopts pseudocode comparator to treat -1.0% as risk-off; WP ref: WP §4.4 (pseudocode) vs WP §4.1 (prose) pending PM decision
BTC_RISK_OFF_COMPARATOR_PROSE = "<"  # why: encoded strict comparator from prose "more than 1.0%" for PM decision; WP ref: WP §4.1
...
- ls -la logs
NOTES/RISKS:
- STATUS set to FAIL due to open P1: BTC Risk-Off comparator ambiguity at exactly -1.0% (WP §4.1 prose vs §4.4 pseudocode) awaiting PM/orchestrator decision.
- Repo-root `_selftest_backup/` exists; need policy confirmation whether to keep/ignore or delete for Stage1 acceptance.
- __pycache__/ and *.pyc artifacts created by py_compile; need policy on cleanup/ignore for reproducible runs.
- Stage1 evidence commands produced no stdout/stderr; outputs recorded as empty by design.
